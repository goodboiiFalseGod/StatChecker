    ...
    public class CHR_INS
    {
        ...
        public class WorldChrMan
        {
            internal class WorldChrManPtr
            {
                ...
                public static IntPtr GetPlayerAnimationPtr()
                {
                    var LocalPlayerExtra_ = GetPlayerExtraPtr();

                    var AnimPtr = IntPtr.Add(LocalPlayerExtra_, 0x28);
                    AnimPtr = new IntPtr(Memory.ReadInt64(AnimPtr));
                    return AnimPtr;
                }
            ...
            public class ChrBasicInfo
            {
                ...
                public static void WritePosition(float PosX, float PosY, float PosZ)
                {
                    var PosPtr = WorldChrMan.WorldChrManPtr.GetPlayerPositionPtr();

                    Memory.WriteFloat(PosPtr + 0x80, PosX);
                    Memory.WriteFloat(PosPtr + 0x84, PosY);
                    Memory.WriteFloat(PosPtr + 0x88, PosZ);

                }

                public static void WritePosition(Vector3 Position)
                {
                    var PosPtr = WorldChrMan.WorldChrManPtr.GetPlayerPositionPtr();
                ...
                public static float GetPosAngle()
                {
                    var PosPtr = WorldChrMan.WorldChrManPtr.GetPlayerPositionPtr();

                    float Angle = Memory.ReadFloat(PosPtr + 0x74);
                    return Angle;
                }
                ...
                public static void WriteAngle(float Angle)
                {
                    ...
                    var Adress = IntPtr.Add(PosPtr, 0x74);
                    Memory.WriteFloat(Adress, Angle);
                ...
                public static void ApplyEffect(int EffectId)
                {
                    var buffer = new byte[]
                    {
                        0x48, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //mov rax,[Alloc]
                        0x48, 0x8B, 0xD0, //mov rdx, rax
                        0x48, 0xA1, 0x78, 0x8E, 0x76, 0x44, 0x01, 0x00, 0x00, 0x00, //mov rax,[144768E78]
                        0x48, 0x8B, 0x80, 0x80, 0x00, 0x00, 0x00, // mov    rax, [rax+80]
                        0x4C, 0x8B, 0xC0, //mov    r8, rax
                        0x48, 0x8B, 0xC8, //mov    rcx, rax
                        0x48, 0x83, 0xEC, 0x48, //sub    rsp, 48
                        0x49, 0xBE, 0x40, 0x6C, 0x88, 0x40, 0x01, 0x00, 0x00, 0x00, //mov    r14, 140886C40
                        0x41, 0xFF, 0xD6, //call   r14
                        0x48, 0x83, 0xC4, 0x48, //add    rsp, 48
                        0xC3 //ret
                    };

                    byte[] bytes = BitConverter.GetBytes(EffectId);
                ...
                public static void DebugApplyEffect(int EffectId, int ActionType)
                {
                    byte[] buffer = new byte[]
                    {
                        0x48, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                        0x48, 0x8B, 0xD0,
                        0x48, 0xb8, 0x78, 0x8e, 0x76, 0x44, 0x01, 0x00, 0x00, 0x00,
                        0x48, 0x8b, 0x08,
                        0x48, 0x8b, 0x89, 0x80, 0x00, 0x00, 0x00,
                        0x48, 0x8b, 0x89, 0xc8, 0x11, 0x00, 0x00,
                        0x48, 0x83, 0xec, 0x28,
                        0x49, 0xbe, 0x30, 0x3c, 0x9f, 0x40, 0x01, 0x00, 0x00, 0x00,
                        0x41, 0xff, 0xd6,
                        0x48, 0x83, 0xc4, 0x28,
                        0xc3
                    };
                    ...
                    Adress = IntPtr.Add(Adress, 0x11C8);
                    Adress = new IntPtr(Memory.ReadInt64(Adress));
                    Adress = IntPtr.Add(Adress, 0x30);

                    Memory.WriteInt32(Adress, EffectId);

                    byte[] bytes = BitConverter.GetBytes(ActionType);
                    Memory.ExecuteBufferFunction(buffer, bytes);
                }
                
                public static void AddSouls(int EffectId)
                {
                    var buffer = new byte[]
                    {
                    0x48, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // mov    rax, [Amount]
                    0x48, 0x8B, 0xD0, //mov    edx, rax
                    0x48, 0xA1, 0x78, 0x8E, 0x76, 0x44, 0x01, 0x00, 0x00, 0x00, //mov    rcx, [DarkSoulsIII.exe+4768E78]
                    0x48, 0x8B, 0x80, 0x80, 0x00, 0x00, 0x00, // mov    rcx, [rcx+80]
                    0x48, 0x8B, 0x88, 0xA0, 0x1F, 0x00, 0x00, //mov    rcx, [rcx + 1FA0]
                    0x48, 0x83, 0xEC, 0x28, //sub    rsp, 28
                    0x49, 0xBE, 0x10, 0x33, 0x5A, 0x40, 0x01, 0x00, 0x00, 0x00, //mov r14, 140886C40
                    0x41, 0xFF, 0xD6, //call   r14
                    0x48, 0x83, 0xC4, 0x28, //add    rsp, 28
                    0xC3 //ret
                    };
            ...
            {
                public static void PlayAnimation(string BehaviorName)
                {
                    var buffer = new byte[]
                    {
                        ...
                        0x48, 0xA1, 0x78, 0x8E, 0x76, 0x44, 0x01, 0x00, 0x00, 0x00, //mov rax,[144768E78]
                        0x48, 0x8B, 0x80, 0x80, 0x00, 0x00, 0x00, //mov rax,[rax+80]
                        0x48, 0x8B, 0x80, 0x90, 0x1F, 0x00, 0x00, //mov rax,[rax+1F90]
                        0x48, 0x8B, 0x40, 0x28, //mov rax,[rax+28]
                        0x48, 0x8B, 0x40, 0x10, //mov rax,[rax+10]
                        0x48, 0x8D, 0x40, 0x28, //lea rax,[rax+28]
                        0x48, 0x8B, 0xC8, //mov rcx,rax
                        0x48, 0x83, 0xEC, 0x28, //sub rsp,28
                        0x49, 0xBE, 0x50, 0x44, 0xD8, 0x40, 0x01, 0x00, 0x00, 0x00, //mov r14,0000000140D84450
                        0x41, 0xFF, 0xD6, //call r14
                        0x48, 0x83, 0xC4, 0x28, //add rsp,28
                        0xC3 //ret
                    };

                    byte[] bytes = Encoding.Unicode.GetBytes(BehaviorName);
                ...
                public static void ApplyEffect(int EffectId)
                {
                    ...
                    0x48, 0xBA, 0, 0, 0, 0, 0, 0, 0, 0, //mov rdx,Alloc
                    0x48, 0xA1, 0x78, 0x8E, 0x76, 0x44, 0x01, 0x00, 0x00, 0x00, //mov rax,[144768E78]
                    0x48, 0x8B, 0x80, 0x80, 0x00, 0x00, 0x00, //mov rbx,[rbx+80]
                    0x4C, 0x8B, 0xC0, //mov r8,rbx
                    0x48, 0x8B, 0xC8, //mov rcx,rbx                    
                    0x48, 0x83, 0xEC, 0x48, //sub rsp, 48
                    0x49, 0xBE, 0x40, 0x6C, 0x88, 0x40, 0x01, 0x00, 0x00, 0x00, //mov r14, 140886C40
                    0x41, 0xFF, 0xD6, //call   r14
                    0x48, 0x83, 0xC4, 0x48, //add    rsp, 48
